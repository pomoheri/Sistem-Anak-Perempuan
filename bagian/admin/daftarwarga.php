                                         ...
                                         <p>Satuan Tugas Penanganan Masalah Perempuan dan Anak <br>
                                          Desa Katekan Kecamatan Gantiwarno Kabupaten Klaten</p>
                                            ...
                                            <table width="100%" class="table table-striped table-bordered table-hover data">
                                                <?php
                                                include("../../koneksi.php");
                                                $result = mysql_query("SELECT * FROM datwg JOIN datrt ON datrt.idrt=datwg.idrt JOIN datrw ON datrw.idrw=datrt.idrw JOIN dukuh ON dukuh.iddk=datrw.iddk ORDER BY nik");
                                                ?>
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                ...
                                                while($user_data = mysql_fetch_array($result)){
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><?php echo $user_data['namarw'];?></td>
                                                    <td><?php echo $user_data['namadk'];?></td>
