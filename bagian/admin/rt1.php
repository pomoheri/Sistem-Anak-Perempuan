            ...
            <!-- Buat isi content di dalam sini -->
             <div class="section__content section__content--p30">
                    <div class="container-fluid">
                       ...
                       <?php
                          include('../../koneksi.php');
                          $query = mysql_query("Select * FROM rw where idrw='$_GET[id]'");
                          $data = mysql_fetch_array($query);
                        ?>
                                <div class="card">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                           ...
                                           <div class="row form-group">
                                              ...
                                              <div class="row form-group" hidden>
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="idrw" id="idrw" class="form-control" readonly>
                                                        <?php
                                                         $query_kon="SELECT * FROM datrw";
                                                         $sql_kon=mysql_query($query_kon);
                                                         while ($data_kon=mysql_fetch_array($sql_kon)) {
                                                          if ($data['idrw']==$data_kon['idrw']) {
                                                           $select="selected";
                                                          }else{
                                                           $select="";
                                                          }
                                                          echo "<option $select>".$data_kon['idrw']."</option>";
                                                         }
                                                        ?>      
                                                    </select>
                                                </div>
