                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                           ...
                                           <div class="row form-group">
                                              ...
                                              <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="iddk" class="form-control" required>
                                                      <?php 
                                                        include('../../koneksi.php');
                                                        $sql=mysql_query('SELECT * FROM dukuh ORDER by iddk DESC');
                                                        $no=1;
                                                         while ($data=mysql_fetch_array($sql)) { 
                                                        ?>
                                                        <option  value= "<?php echo $data['iddk']?>"> <?php echo $data['namadk']?></option>
                                                        <?php $no++; } ?>
                                                      </select>
                                                </div>
                                            </div>                              
