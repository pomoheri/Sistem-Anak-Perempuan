                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <!--isi konten disini-->
							 ...
							 <hr></hr>
							 <hr></hr>
							 <center><h4>DAFTAR RW</h4></center>
							 
						<?php
						include("../../koneksi.php");
						$result = mysql_query("SELECT * FROM dukuh JOIN datrw ON dukuh.iddk=datrw.iddk ORDER BY idrw ASC");
						?>
                                <thead>
                                    <tr>
										<th>No</th>
								...
								<tr>
								<td><?php echo $no; ?></td>
								<td><center><?php echo $user_data['iddk']?></center></td>
								<td><center><?php echo $user_data['namarw']?></center></td>
								<td><center><?php echo $user_data['namadk']?></center></td>
								</tr>
								</tbody>
								<?php $no++; }?>	
							</table>
