                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
						...
						?>
								...
								<tr>
								<td><?php echo $no; ?></td>
								<td><center><?php echo $user_data['idrt']?></center></td>
								<td><center><?php echo $user_data['namart']?></center></td>
								<td><center><?php echo $user_data['namarw']?></center></td>
								</tr>
								</tbody>
								<?php $no++; }?>	
							</table>
