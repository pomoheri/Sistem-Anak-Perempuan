                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
						...
						?>
								...
								<tr>
								<td><?php echo $no; ?></td>
								<td><center><?php echo $user_data['namap']?></center></td>
								<td><center><?php echo $user_data['alamatp']?></center></td>
								<td><center><?php echo $user_data['telpp']?></center></td>
								<td><center><?php echo $user_data['tglcatat']?></center></td>
								<td><center><?php echo $user_data['level']?></center></td>
								<td><center><?php echo $user_data['statpeng']?></center></td>
								</tr>
								</tbody>
								<?php $no++; }?>	
							</table>
