...
<body id="page-top">
  <div id="wrapper">
    <!-- Sidebar -->
     <?php include('../komponen/sidebarmas.php');?> 
    <!-- Sidebar -->
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class=" mb-0 text-gray-800">Tambah Aduan</h5>
            <ol class="breadcrumb">
                       ...
                       ?>
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                           ...
                                           <div class="row form-group" hidden>
                                            ...
                                            <div class="row form-group" hidden>
                                              <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                  <input type="text" id="text-input" name="jenkas" value="Aduan" class="form-control" >  
                                                </div>
                                           </div>
                                           <div class="row form-group" hidden>
                                              <div class="col col-md-3">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="inputkas">
